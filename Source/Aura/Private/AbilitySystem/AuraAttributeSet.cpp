...
void UAuraAttributeSet::HandleIncomingDamage(const FEffectProperties& Props)
{
	...
	if (LocalIncomingDamage > 0.f)
	{
		...
		if (!bFatal)
		{
			...
			// https://www.udemy.com/course/unreal-engine-5-gas-top-down-rpg/learn/lecture/40456912#questions/22616107
			...
			{
				if (Props.TargetCharacter->GetCharacterMovement())
				{
...
//310_ gameplayeffect를 코드로 생성하여 적용
...
void UAuraAttributeSet::ShowFloatingText(const FEffectProperties& Props, float Damage, bool bBlockedHit, bool bCriticalHit) const
{
	if (IsValid(Props.TargetCharacter)) {
		if (Props.SourceCharacter != Props.TargetCharacter) {
			...
			//lec 182 _ this is for enemy hitting and showing dmg to player
