...
{
	if (APlayerController* PC = WorldContextObject->GetWorld()->GetFirstPlayerController() /*UGameplayStatics::GetPlayerController(WorldContextObject, 0)*/)
	{
...
bool UAuraAbilitySystemLibrary::IsNotFriend(AActor* FirstActor, AActor* SecondActor)
{
	...
	if ((FirstIsPlayer && SecondIsEnemy) || (SecondIsPlayer && FirstIsEnemy))
	{
		return true;
	}
	return false;
